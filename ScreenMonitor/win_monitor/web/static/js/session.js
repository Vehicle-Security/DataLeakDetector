...
function createEventElement(event) {
    ...
    // 检测方法（如果是browser_file_monitor检测到的，特别标注）
    const detectionBadge = event.detection_method === 'browser_file_monitor'
        ? `<span class="detection-badge" style="background: #E91E63; color: white; padding: 2px 6px; border-radius: 3px; font-size: 0.85em;">🔍 File Access Detected</span>`
        : '';
