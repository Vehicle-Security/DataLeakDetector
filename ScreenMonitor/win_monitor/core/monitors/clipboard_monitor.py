...
try:
    ...
    HAS_WIN32 = False
    print("[CLIPBOARD] Warning: pywin32 not installed, clipboard monitoring disabled")
...
class ClipboardMonitor:
    ...
    def start(self):
        """启动监控"""
        if not HAS_WIN32:
            print("[CLIPBOARD] Cannot start: pywin32 not available")
            return False
    ...
    def _emit_event(self, event_type: str, data: Dict):
        ...
        print(f"{emoji} [{event_type}] from {proc_name}")
