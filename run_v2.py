from keyframe_extract import keyframe_extract, extract_frames_around_keyframes
import os
from frame_recongnize import process_directory
from final_decision import result

# 指定视频路径
video_path = '/Users/tujiali/Desktop/v1.mov'
# 关键帧保存目录
output_dir   = 'output2'
