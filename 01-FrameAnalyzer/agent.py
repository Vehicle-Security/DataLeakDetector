...
class VideoFileOperationAgent:
    ...
    def _default_vlm_model(cls) -> str:
        return cls._first_env("VL_MODEL_NAME", "MODEL_NAME", "OPENAI_MODEL", "QWEN_VL_MODEL", "QWEN_MODEL") or "qwen3.7-plus"
...
"""
    ...
    def behavior_analysis_node(self, state: AgentState) -> AgentState:
        ...
        save_dir = os.getenv("DLD_VLM_DEBUG_DIR", os.path.join(repo_root, "spec", "vlm_debug_frames"))
